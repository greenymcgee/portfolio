...
/**
 * See this comment in this GH issue:
...
export const PRISMA_ERROR_CODE_TO_CLASS_MAP = {
...
export type PrismaErrorCodeToClassKeys =
  keyof typeof PRISMA_ERROR_CODE_TO_CLASS_MAP

export type PrismaHTTPErrorCodeKey = Extract<
  PrismaErrorCodeToClassKeys,
  | 'P2000'
  | 'P2001'
  | 'P2002'
  | 'P2003'
